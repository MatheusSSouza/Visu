        ...
        try {
            ...
            while (arquivo.ready()) {
                ...
                while (cont < _numCell) {
                    ...
                    Point3d p3 = new Point3d(malha.vertice.get(cl[3]).getCoords(0)
                            , malha.vertice.get(cl[3]).getCoords(1), malha.vertice.get(cl[3]).getCoords(2));
...
//                    }
                    ...
                    ta.setCoordinate((cont*3)-3, p1);
                    ta.setCoordinate((cont*3)-2, p2);
